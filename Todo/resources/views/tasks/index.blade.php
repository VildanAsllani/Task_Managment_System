...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-ui" action="{{route('tasks.store')}}" method="POST">
                @csrf
                <div class="form-group">
                    <label class="form-group-label">Task title</label>
                    <input type="text" class="form-group-input" value="{{ old('task') }}" name="task">
                    @error('task')                                   
                    <div class="error">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-group-input"  rows="5" name="task_description">{{old('task_description')}}</textarea>
